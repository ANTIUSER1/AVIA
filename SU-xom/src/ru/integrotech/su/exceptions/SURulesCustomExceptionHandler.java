...
public class SURulesCustomExceptionHandler implements CustomExceptionHandler{
	...
	@Override
	public void handleActionException(Exception e, RuleInstance rule) throws Exception {
		   log.log(Level.WARNING, e.getMessage());
		   RegisterLoader.getInstance("").release();
		   log.log(Level.WARNING, "Cache  was released successfully by CustomExceptionHandler");
		   throw e;	
	}
