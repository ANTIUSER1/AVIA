...
public class Flight {
	...
	public static Flight of(Airport origin, Airport destination, int distance,
			Airline airline) {
	...
	public static Flight of(Flight flight) {
		return new Flight(flight.origin, flight.destination, flight.distance,
				flight.carriers);
	}
	...
	private Flight(Airport origin, Airport destination, int distance,
			Map<Airline, FlightCarrier> carrierMap) {
		this.code = Flight.createCode(origin, destination);
		this.origin = origin;
		this.destination = destination;
		this.distance = distance;
	...
	public String toString() {
		...
		sb.append(String
				.format("  Flight: %s %,8d mi     afl: %5s, %5s     skyteam: %5s, %5s ",
						this.code, this.distance, this.getAflZones(),
						this.getAflReverseZones(), this.getScyteamZones(),
						this.getScyteamReverseZones()));
		sb.append(String.format("\n    Carriers: %d", this.carriers.keySet()
				.size()));
