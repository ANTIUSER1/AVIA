...
class RequiredAward implements Comparable<RequiredAward> {
    ...
    static final String UO_TYPE = "UO";
    static final String UC_TYPE = "UC";

    static RequiredAward of(Bonus bonus, int minMiles, int maxMiles) {
        ...
        boolean fitsMilesInterval = bonus.getValue() >= minMiles
                && bonus.getValue() <= maxMiles;
