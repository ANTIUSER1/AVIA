...
class MilesAmount {
	...
	public static MilesAmount of(PassengerCharge charge) {
		...
		return new MilesAmount(Airline.of(charge.getAirline()),
				ClassOfService.of(charge.getServiceClass()),
				charge.getDistance(), fareGroups);
	}
	...
	private MilesAmount(Airline airline, ClassOfService classOfService,
			int distance, List<Fare> fareGroups) {
	...
	public String toString() {
		...
		builder.append("MilesAmount [airline=");
		builder.append(airline);
		builder.append(", classOfService=");
		builder.append(classOfService);
		builder.append(", distance=");
		builder.append(distance);
		builder.append(", fareGroups=");
		builder.append(fareGroups);
		builder.append("]");
