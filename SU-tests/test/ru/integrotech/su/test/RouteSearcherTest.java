...
public class RouteSearcherTest {
	...
	public void init() {
		...
		this.routesBuilder = RoutesBuilder.of(MockLoader.getInstance()
				.getRegisterCache());
	}
	...
	private List<Route> getExpected(String jsonName) {
		...
		try {
			...
			result = loader.getTestsCache().loadRoutes(jsonElement,
	...
	public void PRINT_ACTUAL() throws Exception {
		RoutesInput routesInput = RoutesInput.of("city", // from type
				"LED", // from
				null, // to type
				null, // to
				null // airline
	...
	@Test
	public void MOW_VVO() throws Exception {
		RoutesInput routesInput = RoutesInput.of("city", // from type
				"MOW", // from
				"city", // to type
				"VVO", // to
	...
	// http://support.integrotechnologies.ru/issues/21958
	@Test
	public void MOW_CIS() throws Exception {
		RoutesInput routesInput = RoutesInput.of("city", // from type
				"MOW", // from
				"region", // to type
				"CIS", // to
	...
	@Test
	public void MOW_EU() throws Exception {
		RoutesInput routesInput = RoutesInput.of("city", // from type
				"MOW", // from
				"region", // to type
				"EU", // to
	...
	@Test
	public void SVO_GMP() throws Exception {
		RoutesInput routesInput = RoutesInput.of("airport", // from type
				"SVO", // from
				"airport", // to type
				"GMP", // to
				"SU" // airline
	...
	@Test
	public void SVO_NRT() throws Exception {
		RoutesInput routesInput = RoutesInput.of("airport", // from type
				"SVO", // from
				"airport", // to type
				"NRT", // to
	...
	@Test
	public void SVO_PRG() throws Exception {
		RoutesInput routesInput = RoutesInput.of("airport", // from type
				"SVO", // from
				"airport", // to type
				"PRG", // to
	...
	@Test
	public void SVO_FRA() throws Exception {
		RoutesInput routesInput = RoutesInput.of("airport", // from type
				"SVO", // from
				"airport", // to type
				"FRA", // to
	...
	@Test
	public void LED_AER() throws Exception {
		RoutesInput routesInput = RoutesInput.of("airport", // from type
				"LED", // from
				"airport", // to type
				"AER", // to
	...
	@Test
	public void LED_CIS() throws Exception {
		RoutesInput routesInput = RoutesInput.of("airport", // from type
				"LED", // from
				"region", // to type
				"CIS", // to
	...
	@Test
	public void MOW_WORLD() throws Exception {
		RoutesInput routesInput = RoutesInput.of("city", // from type
				"MOW", // from
				null, // to type
				null, // to
