...
public class ChargeToString {
	...
	@Test
	public void printCharge() throws Exception {
		ChargeInput chargeInput = ChargeInput.of("City", // from
				...
				"Basic", // loyalty
				false); // is round
		List<ChargeRoute> result = this.chargeBuilder
	...
	@Test
	public void printChargeForODM() throws Exception {
		...
		ResultMilesCharge result = this.chargeBuilder.buildResult(routes,
				chargeInput);
		Gson gson = new GsonBuilder().setPrettyPrinting().create();
		String jsonResult = gson.toJson(result);
		System.out.println(jsonResult);
